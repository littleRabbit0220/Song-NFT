        ...
        <div className=' flex flex-col  max-w-[500px] w-full mx-auto py-16 md:px-0 px-5 text-center'>
          ...
          <div className='w-full mt-7 '>
            ...
            >
              ...
              <Link
                href='/signup'
                className='font-bold flex items-center justify-center bg-white text-MoshDark-7 h-[44px] rounded mt-3 sm:mt-0 sm:ml-2.5 sm:w-auto w-full min-w-[110px] hover:bg-MoshLight-2'
              >
                Subscribe
              </Link>
            </form>
